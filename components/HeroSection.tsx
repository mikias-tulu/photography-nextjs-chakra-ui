      ...
      <Container maxW={"3xl"}>
        ...
        >
          ...
          <Stack
            ...
            position={"relative"}
          >
            <Link href="/gallery/all-photos" passHref>
              <Button
                colorScheme="yellow"
                bg="yellow.400"
                rounded="full"
            ...
            <Link href="https://en.wikipedia.org/wiki/History_of_Addis_Ababa" passHref>
              <Button as="a" variant="link" colorScheme="black" size="sm">
                Learn more about Addis
              </Button>
            </Link>
